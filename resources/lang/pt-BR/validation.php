...
return [
    ...
    */
    ...
    | a convenção "atributo.regra" para nomear as linhas. Isso facilita
    | definir uma mensagem específica para uma regra de atributo.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | As linhas a seguir são usadas para substituir o placeholder de atributo
    | por algo mais amigável, como "Endereço de E-mail" em vez de "email".
    | Isso ajuda a tornar as mensagens mais expressivas.
    |
    */
